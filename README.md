...
Siftr는 광고도 인앱 결제도 없는 **완전 무료 앱**입니다. 한 명의 개발자가 만들고 유지하고 있어요. 도움이 되었다면 커피 한 잔으로 개발을 응원해 주세요 — 큰 힘이 됩니다. ☕️

[![ko-fi](https://ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/suho_park)
